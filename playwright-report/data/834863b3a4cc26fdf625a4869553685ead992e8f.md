...
- Name: prescription.spec.ts >> Prescription – medicine autocomplete >> typing in medicine input shows suggestions
- Location: tests\e2e\prescription.spec.ts:148:5
...
Call log:
  - waiting for getByText('Nom du médicament').first().locator('..').locator('input').first()
