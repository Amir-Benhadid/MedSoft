...
- Name: refraction.spec.ts >> Refraction – copy buttons >> OG → OD copy button is visible
- Location: tests\e2e\refraction.spec.ts:149:5
...
Locator: getByRole('button', { name: /OG.*OD/i }).or(locator('button').filter({ hasText: 'OG' }).filter({ hasText: 'OD' }))
Expected: visible
Error: strict mode violation: getByRole('button', { name: /OG.*OD/i }).or(locator('button').filter({ hasText: 'OG' }).filter({ hasText: 'OD' })) resolved to 2 elements:
...
Call log:
  ...
  - waiting for getByRole('button', { name: /OG.*OD/i }).or(locator('button').filter({ hasText: 'OG' }).filter({ hasText: 'OD' }))
