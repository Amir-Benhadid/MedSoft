...
- Name: save-and-finish.spec.ts >> Save – manual save >> clicking Sauvegarder triggers save and shows success toast
- Location: tests\e2e\save-and-finish.spec.ts:29:5
...
```ts
  1   | /**
  2   |  * E2E: Save & Finish Consultation Workflow
  3   |  *
