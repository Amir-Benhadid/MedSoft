...
- Name: prescription.spec.ts >> Prescription – save >> can save consultation with prescriptions
- Location: tests\e2e\prescription.spec.ts:202:5
...
Call log:
  - waiting for getByText('Dosage').first().locator('..').locator('input')
