...
- Name: prescription.spec.ts >> Prescription – editing fields >> fills durée field
- Location: tests\e2e\prescription.spec.ts:116:5
...
Call log:
  - waiting for getByText('Durée').first().locator('..').locator('input')
