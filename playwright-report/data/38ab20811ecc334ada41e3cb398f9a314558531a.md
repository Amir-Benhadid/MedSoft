...
- Name: prescription.spec.ts >> Prescription – empty state >> shows Nouveau médicament button
- Location: tests\e2e\prescription.spec.ts:44:5
...
Locator: getByRole('button', { name: /Nouveau médicament|New Medicine/i })
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Nouveau médicament|New Medicine/i })
