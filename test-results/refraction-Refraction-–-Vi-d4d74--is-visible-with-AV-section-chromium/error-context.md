...
- Name: refraction.spec.ts >> Refraction – Visual Acuity >> OG eye panel is visible with AV section
- Location: tests\e2e\refraction.spec.ts:39:5
...
Locator: getByText('OG')
Expected: visible
Error: strict mode violation: getByText('OG') resolved to 9 elements:
    ...
    2) <span class="font-bold uppercase tracking-widest text-blue-700">OG</span> aka locator('span').filter({ hasText: 'OG' })
    3) <button type="button" title="Copier OD vers OG" class="inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:text-accent-foreground rounded-md h-5 xl:h-6 2xl:h-8 px-1.5 xl:px-2 text-[10px] xl:text-xs 2xl:text-sm hover:bg-blue-100">…</button> aka getByRole('button', { name: 'OD → OG' })
    4) <label class="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 font-bold text-slate-500 uppercase tracking-tight">Antécédents Ophtalmologiques</label> aka getByText('Antécédents Ophtalmologiques')
    5) <h4 class="text-xs font-extrabold text-white uppercase tracking-tight">OG</h4> aka getByText('OG').nth(4)
    6) <h4 class="text-xs font-extrabold text-white uppercase tracking-tight">OG</h4> aka getByText('OG').nth(5)
    7) <label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-[10px] font-semibold text-blue-700 uppercase tracking-tight w-8 shrink-0">OG</label> aka getByText('OG', { exact: true }).nth(3)
    8) <label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-[10px] font-semibold text-blue-700 uppercase tracking-tight w-8 shrink-0">OG</label> aka getByText('OG', { exact: true }).nth(4)
    9) <label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-[10px] font-semibold text-teal-700 uppercase tracking-tight w-8 shrink-0">OG</label> aka getByText('OG', { exact: true }).nth(5)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('OG')
