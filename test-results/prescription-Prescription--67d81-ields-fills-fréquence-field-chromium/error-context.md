...
- Name: prescription.spec.ts >> Prescription – editing fields >> fills fréquence field
- Location: tests\e2e\prescription.spec.ts:109:5
...
Call log:
  - waiting for getByText('Fréquence').first().locator('..').locator('input')
