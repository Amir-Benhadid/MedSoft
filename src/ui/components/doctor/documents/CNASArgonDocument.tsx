...
interface CNASArgonDocumentProps {}

// PDF Generation Function
export const generateCNASArgonPDF = async (
	...
	// Description
	const descriptionText = "Le(la) sus-nommé(e) présente à l'examen du jour un laser Argon Cotation: K80";
...
// UI Component
const CNASArgonDocument: React.FC<CNASArgonDocumentProps> = () => {
			...
			<Card className="bg-card rounded-xl p-3 border border-border shadow-sm">
				<CardContent className="p-0 space-y-2">
					...
					<p className="text-xs text-muted-foreground italic">
						Le(la) sus-nommé(e) présente à l'examen du jour un laser Argon Cotation: K80
					</p>
				</CardContent>
			</Card>
		</div>
...
export default memo(CNASArgonDocument);
