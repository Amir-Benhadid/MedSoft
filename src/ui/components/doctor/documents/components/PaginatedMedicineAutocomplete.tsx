...
interface PaginatedMedicineAutocompleteProps {
    value: string;
...
const PaginatedMedicineAutocomplete: React.FC<PaginatedMedicineAutocompleteProps> = ({
    value,
    onChange,
    ...
    // Force close popover on route change (like navigating back)
    useEffect(() => {
        setOpen(false);
...
export default PaginatedMedicineAutocomplete;
