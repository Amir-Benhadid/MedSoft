...
interface CNASOCTMDocumentProps {}

// PDF Generation Function
export const generateCNASOCTMPDF = async (
	...
	// Description
	const descriptionText = "Le(la) sus-nommé(e) présente à l'examen du jour une optic coherence tomography Indication: maculopathie Cotation: K80";
...
// UI Component
const CNASOCTMDocument: React.FC<CNASOCTMDocumentProps> = () => {
			...
			<Card className="bg-card rounded-xl p-3 border border-border shadow-sm">
				<CardContent className="p-0 space-y-2">
					...
					<p className="text-xs text-muted-foreground italic">
						Le(la) sus-nommé(e) présente à l'examen du jour une optic coherence tomography Indication: maculopathie Cotation: K80
					</p>
				</CardContent>
			</Card>
		</div>
...
export default memo(CNASOCTMDocument);
